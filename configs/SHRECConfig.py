...
class SHRECConfig(Config):
    ...
    ####################
    split = 'training'
    num_train = 100  # -1 for all. It will crash if this is more than the actual number of training shapes
    ...
    # epoch management
    max_epoch = 1000  # for surreal and more than 2k shapes, usually 50 epochs are enough. for 100, go to 1000 epoch
