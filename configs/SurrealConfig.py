...
class SurrealConfig(Config):
    ...
    # number of shapes #
    ####################
    split = 'training'  # by default
    num_train = 500  # 2000  # -1 for all. It will crash if this is more than the actual number of training shapes
    ...
    # epoch management
    max_epoch = 5000  # for surreal and more than 2k shapes, usually 50 epochs are enough. for 100, go to 1000 epoch
