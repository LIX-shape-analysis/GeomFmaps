...
class SCAPE_r_Dataset(Dataset):
    ...
    def __init__(self, config):
        ...
        self.dataset_name = 'SCAPE_r'
        self.path = '../../../media/donati/Data1/Datasets/SCAPE_r/'
        self.data_folder = 'off_2/'
        self.spectral_folder = 'spectral/'
        self.txt_file = 'SCAPE_r_training.txt'
        self.txt_file_test = 'SCAPE_r_test.txt'
    ...
    def get_batch_gen(self, config):
        ...
        def random_balanced_gen():
            ...
            if config.split == 'train':
                ...
                print('FAUST/SCAPE setting')
                n_shapes = self.num_train
                gen_indices = []
