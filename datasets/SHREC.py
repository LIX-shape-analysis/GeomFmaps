...
class SHREC_Dataset(Dataset):
    ...
    def __init__(self, config):
        ...
        self.dataset_name = 'SHREC'
        self.path = '../../../media/donati/Data1/Datasets/SHREC/'
        self.data_folder = 'off_2/'  # obtained through re scaling, shapes aligned to y-axis
        self.spectral_folder = 'spectral/'
        self.txt_file = 'SHREC_test.txt'  # not necessary since SHREC is only for testing
        self.txt_file_test = 'SHREC_test.txt'
