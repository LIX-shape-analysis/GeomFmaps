...
class SHREC_r_Dataset(Dataset):
    ...
    def __init__(self, config):
        ...
        self.dataset_name = 'SHREC_r'
        self.path = '../../../media/donati/Data1/Datasets/SHREC_r/'
        self.data_folder = 'off_2/'  # obtained through re scaling, shapes aligned to y-axis
        self.spectral_folder = 'spectral/'
        self.txt_file = 'SHREC_r_test.txt'  # not necessary since SHREC is only for testing
        self.txt_file_test = 'SHREC_r_test.txt'
    ...
    def get_batch_gen(self, config):
        ...
        def random_balanced_gen():
            print('trying to generate batch series...')
            ...
            if config.split == 'train':
                ...
                print('SHREC setting')
                pairs = np.loadtxt(self.path + '/test_pairs.txt',
                ...
                print('we have ', gen_indices.shape, 'to compute :', gen_indices)
            else:
                raise ValueError('configuration split (train/test) undefined')
