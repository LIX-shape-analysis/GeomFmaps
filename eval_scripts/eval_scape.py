...
log = 'Log_2020-03-28_17-51-04'  #FAUST 70eig
#log = 'Log_2020-03-29_08-42-02'
log = 'Log_2020-03-29_20-41-26' #s500 100eig
...
foldername = join('../test',log, 'SCAPE_r/'+str(epoch)+'_epochs')
...
for i_b in range(len(bi1)):
    #if i_b == 2 : break
    #print(i_b)
    i_s = bi1[i_b] + 52 #number of training shapes (offset)
    i_t = bi2[i_b] + 52
    ...
    geodist_folder = '../../../../media/donati/Data1/GeoDistanceMatrix/SCAPE_remesh'
    ...
    # vts
    vts_folder = '../../../../media/donati/Data1/Datasets/SCAPE_r/corres/'
    ...
    # params_to_save = {}
    # params_to_save['matches'] = T21
    # params_to_save['matches_ref'] = T21_ref
    # savefolder = 'matches/SCAPE/' + log
...
#print('\nThe average geodesic error (refined) is : ', np.mean(mean_err_ref))
...
print(to_save.shape)
#np.save('../../CVPR_Results/SCAPE/SCAPE_matches_2ours'+str(n_tr), to_save)
#np.save('../../CVPR_Results/SCAPE/SCAPE_matches_2ours_ref'+str(n_tr), to_save_ref)
